...
### <a name="build-rich-interactive-user-interfaces"></a>Создание интерактивных пользовательских интерфейсов
...
### <a name="display-and-manipulate-data"></a>Отображение данных и управление ими
...
|Обновление приложений при развертывании через ClickOnce|[Практическое руководство. Управление обновлениями для ClickOnce-приложения](/visualstudio/deployment/how-to-manage-updates-for-a-clickonce-application)|
|Управление безопасностью в ClickOnce|[Практическое руководство. Включение параметров безопасности ClickOnce-приложений](/visualstudio/deployment/how-to-enable-clickonce-security-settings)|
...
|Дополнительные сведения о безопасности в Windows Forms|[Общие сведения о безопасности в Windows Forms](security-in-windows-forms-overview.md)|
