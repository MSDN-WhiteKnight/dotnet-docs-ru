---
title: Дополнительные вопросы безопасности в Windows Forms
ms.date: 03/30/2017
...
---
# <a name="additional-security-considerations-in-windows-forms"></a>Дополнительные вопросы безопасности в Windows Forms
...
Класс <xref:System.Security.Permissions.UIPermission> управляет доступом к буферу обмена; значение перечисления <xref:System.Security.Permissions.UIPermissionClipboard> определяет уровень доступа к нему. В следующей таблице приведены возможные уровни доступа.
