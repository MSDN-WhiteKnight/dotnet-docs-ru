...
## <a name="related-sections"></a>Связанные разделы  
 [Элементы управления и компоненты диалоговых окон](./controls/dialog-box-controls-and-components-windows-forms.md)  
 ...
 [Общие сведения об элементе управления TabControl](./controls/tabcontrol-control-overview-windows-forms.md)  
