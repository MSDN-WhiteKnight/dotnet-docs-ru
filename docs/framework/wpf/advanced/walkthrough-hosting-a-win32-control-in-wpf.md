...
9. Обмениваться данными с размещенным окном, отправляя ему Microsoft Windows сообщения и обрабатывая сообщения из его дочерних окон, таких как уведомления, отправленные элементами управления.  
