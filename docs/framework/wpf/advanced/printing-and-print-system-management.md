...
Windows Vista и Microsoft .NET Framework представить новый способ печати — альтернативы Windows GDI печати и значительно расширенный набор управления системы печати API.  
