...
В Windows Presentation Foundation (WPF) представлены перенаправленные события, которые могут вызывать обработчики, существующие в разных прослушивателях дерева элементов в приложении.  
