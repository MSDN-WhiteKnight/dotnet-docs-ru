...
Достижения оптимальной производительности приложения необходимы предусмотрительность в разработке приложений и понимание рекомендаций по Windows Presentation Foundation (WPF) разработки приложений. В этом разделе представлены дополнительные сведения о построении высокопроизводительных WPF приложений.  
