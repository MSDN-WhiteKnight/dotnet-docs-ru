...
[!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] И WPF технологий есть две модели похожие, но разные свойства. *Сопоставление свойств* поддерживает взаимодействие между этими двумя архитектурами и предоставляет следующие возможности:  
...
## <a name="property-mapping-with-the-windowsformshost-element"></a>Сопоставление свойств с помощью элемента WindowsFormsHost  
 <xref:System.Windows.Forms.Integration.WindowsFormsHost> Элемент преобразует значение по умолчанию WPF свойства, чтобы их [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] эквиваленты, с помощью следующей таблицы преобразования.  
...
-   Видимый  
 ...
 <xref:System.Windows.Forms.Integration.ElementHost> Управления преобразует значение по умолчанию [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] свойства, чтобы их WPF эквиваленты с помощью следующей таблицы преобразования.  
