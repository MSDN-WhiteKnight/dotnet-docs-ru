...
Эта категория охватывает различные базовые классы, интерфейсы и другие элементы и основные понятия, используемые при создании полнофункциональных Windows Presentation Foundation (WPF) элемента управления.  
