...
В этом примере показано, как использовать <xref:System.Windows.Media.Animation.Storyboard> для анимации свойств. Для анимации свойства, с помощью <xref:System.Windows.Media.Animation.Storyboard>, создать анимацию для каждого свойства, которое вы хотите анимировать, а также создать <xref:System.Windows.Media.Animation.Storyboard> для хранения анимации.  
 ...
 Чтобы запустить раскадровку XAML, использовать <xref:System.Windows.Media.Animation.BeginStoryboard> действия и <xref:System.Windows.EventTrigger>. <xref:System.Windows.EventTrigger> Начинает <xref:System.Windows.Media.Animation.BeginStoryboard> действие, когда событие, определяемое его <xref:System.Windows.EventTrigger.RoutedEvent%2A> происходит свойство. <xref:System.Windows.Media.Animation.BeginStoryboard> Началом действия <xref:System.Windows.Media.Animation.Storyboard>.  
