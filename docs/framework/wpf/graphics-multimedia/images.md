...
Windows Presentation Foundation (WPF) предоставляет встроенную поддержку нескольких форматов изображений, отрисовку изображений высокого качества и расширяемость кодеков.  
