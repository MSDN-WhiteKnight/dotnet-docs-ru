...
7. Если вы используете C#, измените `MainWindow` класса, чтобы он наследовал от <xref:System.Windows.Navigation.NavigationWindow>. (В Visual Basic это происходит автоматически при изменении окна в XAML.)
