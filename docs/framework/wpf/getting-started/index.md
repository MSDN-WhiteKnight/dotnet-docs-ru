...
|Как проектировать пользовательский интерфейс приложения?|[Проектирование XAML в Visual Studio](https://docs.microsoft.com/visualstudio/xaml-tools/designing-xaml-in-visual-studio)|  
|Не знакомы с .NET?|[Общие сведения о платформе .NET Framework](https://docs.microsoft.com/ru-ru/dotnet/framework/get-started/overview)<br /><br /> [Основные сведения о приложениях .NET](https://docs.microsoft.com/ru-ru/dotnet/core/introduction)<br /><br /> [Начало работы с Visual C# и Visual Basic](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2015/ide/getting-started-with-visual-csharp-and-visual-basic)|  
...
- [Центр разработчиков .NET](https://www.microsoft.com/net)
